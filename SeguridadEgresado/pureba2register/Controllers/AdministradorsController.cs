...
namespace pureba2register.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdministradorID,Nombre,PrimerApellido,SegundoApellido,Direccion,TelefonoFijo,TelefonoMovil,NumeroDocumento")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdministradorID,Nombre,PrimerApellido,SegundoApellido,Direccion,TelefonoFijo,TelefonoMovil,NumeroDocumento")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
